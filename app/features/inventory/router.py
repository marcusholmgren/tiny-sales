...
from app.features.auth.models import User as AuthUser # Alias to avoid conflict if User is defined locally
from app.features.auth.security import get_current_active_admin_user
