...
print(f"Tests project root: {project_root}") # This line can remain commented
...
from app.main import app as actual_app # Adjusted import to match your structure
...
async def app_for_testing() -> AsyncGenerator[FastAPI, Any]:
    ...
    _app = actual_app # Use the actual app instance from main.py
