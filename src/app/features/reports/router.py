"""Reporting API endpoints for eCommerce analytics
...
from typing import (
    Annotated,
)  # Annotated was missing in original provided file for current_user
...
async def get_order_status_breakdown_report(
    ...
    return await report_service.generate_order_status_breakdown_report(
        current_user=current_user
    )
