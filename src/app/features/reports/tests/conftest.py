...
project_root = Path(__file__).resolve().parents[4]  # Go up from tests -> reports -> features -> app -> src
...
# You can add additional fixtures specific to reports tests here if needed