...
project_root = Path(__file__).resolve().parents[4]  # Go up from tests -> inventory -> features -> app -> src
...
# You can add additional fixtures specific to inventory tests here if needed