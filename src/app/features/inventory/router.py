...
from ..auth.models import (
    User as AuthUser,
)  # Alias to avoid conflict if User is defined locally
...
def _to_inventory_response(inventory_item: InventoryItem) -> InventoryItemResponse:
    ...
    ):  # Accessing .category directly might be problematic if not pre-fetched
...
async def create_inventory_item(
    ...
    try:
        ...
        await inventory_item.fetch_related(
            "category"
