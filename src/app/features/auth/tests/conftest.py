...
project_root = Path(__file__).resolve().parents[4]  # Go up from tests -> auth -> features -> app -> src
...
# You can add additional fixtures specific to auth tests here if needed